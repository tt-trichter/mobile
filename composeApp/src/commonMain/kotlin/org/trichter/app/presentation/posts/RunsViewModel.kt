package org.trichter.app.presentation.posts
...
import org.trichter.app.data.repository.Result
...
class RunsViewModel(private val repository: RunRepository) : ViewModel() {
